...
def batch_upload(
    ...
    for qp in query_params:
        ...
        summary = upload_query(
            creds=neo4j_creds, query=qp[0], params=qp[1], database=neo4j_database
        )
        ...
        try:
            ...
            logger.debug(f"No properties set in summary: {summary}")
...
def upload(
    ...
    # Stub for future deprecation
    # warnings.warn(
    #     "The 'upload' function is deprecated and will be removed in a future version. Use batch_upload() function instead.",
    #     DeprecationWarning,
    #     stacklevel=2,
    # )
    # logging.warning(
    ...
    return batch_upload(config=config, data={"nodes": nodes, "relationships": rels})
